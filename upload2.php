...
if($max_size != '0') {
	$filesize = filesize($_FILES['qqfile']['tmp_name']) / 1048576;

	if (isset($_REQUEST['qqtotalfilesize'])) {
            $filesize = $_REQUEST['qqtotalfilesize'];
        }
...
// Fake download code
$ext = pathinfo(basename($_FILES['qqfile']['name']), PATHINFO_EXTENSION);
...
// Get file size
$file_name = basename($_FILES['qqfile']['name']);
$target_dir = 'uploads/';
